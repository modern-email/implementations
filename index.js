...
const popup = (...kids) => {
	...
	let content;
	const root = dom.div(style({ position: 'absolute', top: 0, right: 0, bottom: 0, left: 0, backgroundColor: 'rgba(0, 0, 0, 0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1 }), function keydown(e) {
		if (e.key === 'Escape') {
			e.stopPropagation();
			close();
		}
